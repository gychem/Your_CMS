...
<div class="container mb-3">
    <div class="w-full">
        ...
        <div class="container w-full mt-3 mx-auto space-y-6 sm:space-y-12">
            <a rel="noopener noreferrer" href="/news/{{ $data['firstArticle']->slug }}" class="block bg-white hover:bg-gray-100 rounded shadow-md max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900">
            ...
            <div class="grid justify-center grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3" style="margin-top:10px">
