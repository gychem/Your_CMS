            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($pages as $page)   
                        <tr onclick="window.location='/{{ $page->slug }}';" class="bg-white border-b cursor-pointer hover:bg-slate-50 dark:bg-gray-700 dark:border-gray-700 dark:hover:bg-slate-600">
                            <td class="py-4 px-6">
                                {{ $page->name }}
                            </td>
                            <td class="py-4 px-6">
